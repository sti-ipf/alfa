...
describe "world_readings/edit.html.erb" do
  before(:each) do
    @world_reading = assign(:world_reading, stub_model(WorldReading,
      :email => "MyString",
  ...
  it "renders the edit world_reading form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => world_readings_path(@world_reading), :method => "post" do
